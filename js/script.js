...
var Mebleg,Ay,Amount,Month;
var kapAmount = document.getElementById("kap-amount");
var kapMonth = document.getElementById("kap-month");
...
function Calculate() {
  ...
  document.querySelector("#inner-amount").innerText =parseFloat(Amount).toLocaleString("en-US", opts) + "₼";

  document.querySelector("#inner-months").innerText = parseFloat(Month).toLocaleString("en-US", opts) + "ay";

  document.querySelector("#total").innerText =parseFloat(total).toLocaleString("en-US", opts) + "₼";
